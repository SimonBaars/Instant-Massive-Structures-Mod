...
public class CityCreator extends CreatorBlocks implements ICreatorBlock {
	int i,j,k;
    ...
    public CityCreator(int x, int y, int z, int nCheckers, World worldIn, World serverWorld){
	...
	private void createCloud() {
		SchematicStructure struct = new SchematicStructure("cloud"+((int)((Math.random()*6)+1))+".structure", true);
	      struct.readFromFile();
